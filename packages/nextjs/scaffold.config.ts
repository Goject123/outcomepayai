...
const targetNetwork =
  process.env.NEXT_PUBLIC_TARGET_NETWORK === "arbitrumSepolia" ? chains.arbitrumSepolia : chains.hardhat;
...
const scaffoldConfig = {
  ...
  burnerWalletMode: targetNetwork.id === chains.hardhat.id ? "localNetworksOnly" : "disabled",
